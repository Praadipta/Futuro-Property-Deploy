...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Kredensial admin tidak valid');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8 relative overflow-hidden">
          ...
          <motion.div variants={itemVariants} className="text-center mb-8 relative">
            ...
            <p className="text-gray-600 text-sm">
              Masuk untuk mengelola properti Futuro Property
            </p>
          </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@futuroproperty.com"
                />
              </div>
            </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-8 text-center">
            <p className="text-xs text-gray-500">
              Akses admin aman • Futuro Property © 2025
            </p>
          </motion.div>
        </div>
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-200 rounded-full text-green-700 text-sm">
            ...
            <span>Diamankan dengan enkripsi 256-bit</span>
          </div>
        </motion.div>
      </motion.div>
    </div>
