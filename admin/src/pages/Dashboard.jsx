...
const Dashboard = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      description: "Listing yang sedang aktif",
      change: "+8%",
      changeType: "positive"
    },
    {
      ...
      description: "Tampilan halaman properti",
      change: "+23%",
      changeType: "positive"
    },
    {
      title: "Janji Temu Tertunda",
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Memuat Dashboard</h3>
          <p className="text-gray-600">Mengambil data terbaru Anda...</p>
        </motion.div>
      </div>
    );
  }
        ...
        >
          <div>
            ...
            <p className="text-lg text-gray-600 flex items-center gap-2">
              ...
              Selamat datang kembali! Berikut perkembangan properti Anda
            </p>
          </div>
            ...
            <div className="flex items-center bg-white rounded-lg shadow-sm border p-1">
              {['7', '30', '90'].map((days) => (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 ${timeRange === days
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                  ...
                  Analitik Tampilan Properti
                </h2>
                <p className="text-sm text-gray-600 mt-1">Pantau interaksi properti Anda dari waktu ke waktu</p>
              </div>
            ...
            <div className="h-[350px]">
              {stats.viewsData && Object.keys(stats.viewsData).length > 0 ? (
                ...
                <div className="h-full flex flex-col items-center justify-center">
                  ...
                  <p className="text-gray-500 font-medium">Tidak ada data tampilan</p>
                  <p className="text-sm text-gray-400">Data akan muncul setelah ada tampilan properti</p>
                </div>
              )}
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Gambaran distribusi</p>
              </div>
            </div>
            <div className="h-[350px]">
              {stats.propertyTypeData && Object.keys(stats.propertyTypeData).length > 0 ? (
                ...
                <div className="h-full flex flex-col items-center justify-center">
                  ...
                  <p className="text-gray-500 font-medium">Tidak ada data properti</p>
                  <p className="text-sm text-gray-400 text-center">Tambahkan properti untuk melihat distribusi</p>
                </div>
              )}
            </div>
          </motion.div>
            ...
            <div className="space-y-4 max-h-[350px] overflow-y-auto">
              {stats.recentActivity?.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 font-medium">Tidak ada aktivitas terbaru</p>
                  <p className="text-sm text-gray-400">Aktivitas akan muncul di sini saat pengguna berinteraksi dengan properti Anda</p>
                </div>
              )}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
                <div>
                  <p className="text-sm text-gray-600">Rata-rata Dilihat per Properti</p>
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                <div>
                  <p className="text-sm text-gray-600">Tingkat Listing Aktif</p>
                  <p className="text-2xl font-bold text-gray-900">
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl">
                <div>
                  <p className="text-sm text-gray-600">Janji Temu Tertunda</p>
