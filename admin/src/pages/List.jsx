...
const PropertyListings = () => {
  ...
  const fetchProperties = async () => {
    try {
      ...
      toast.error("Gagal mengambil properti");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleRemoveProperty = async (propertyId, propertyTitle) => {
    if (window.confirm(`Apakah Anda yakin ingin menghapus "${propertyTitle}"?`)) {
      try {
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          >
            Mengambil daftar properti terbaru...
          </motion.p>
        </div>
      </motion.div>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                  ...
                  <span>{filteredProperties.length} Properti Terdaftar</span>
                </div>
                <div className="flex items-center gap-2">
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Untuk Disewa</p>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Untuk Dijual</p>
                <p className="text-2xl font-bold text-gray-900">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  Rp {properties.length > 0 ? Math.round(properties.reduce((sum, p) => sum + p.price, 0) / properties.length).toLocaleString('id-ID') : 0}
                </p>
              </div>
        ...
        >
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Cari berdasarkan judul, lokasi, atau tipe properti..."
                value={searchTerm}
              ...
              <AnimatePresence>
                {filteredProperties.map((property, index) => (
                  <motion.div
                    ...
                    className={`bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group ${viewMode === 'list' ? 'flex flex-col sm:flex-row' : ''
                      }`}
                  >
                    {/* Property Image */}
                    <div className={`relative ${viewMode === 'list'
                      ...
                      <div className="absolute top-4 right-4">
                        <span className={`px-3 py-1 text-xs font-medium rounded-full backdrop-blur-sm shadow-sm ${property.availability === 'rent'
                          ? 'bg-green-500/90 text-white'
                          : 'bg-blue-500/90 text-white'
                          }`}>
                          Untuk {property.availability === 'rent' ? 'disewa' : 'dijual'}
                        </span>
                      </div>
                      ...
                      <div>
                        <div className="mb-4">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-sm text-gray-500">{property.views || 0} dilihat</span>
                            </div>
                          </div>
                        </div>
                        ...
                        {property.amenities.length > 0 && (
                          <div className="border-t pt-4">
                            <h4 className="text-sm font-medium text-gray-900 mb-3">Fasilitas Utama</h4>
                      ...
                      {viewMode === 'list' && (
                        <div className="flex items-center justify-between pt-4 mt-4 border-t">
                          <div className="text-sm text-gray-500">
                            Terdaftar {new Date(property.createdAt).toLocaleDateString('id-ID')}
                          </div>
                          <div className="flex items-center gap-2">
                            <Link
                              to={`/update/${property._id}`}
