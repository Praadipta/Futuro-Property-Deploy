...
const Signup = () => {
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      case 'name':
        if (!value.trim()) errors.name = 'Nama wajib diisi';
        else if (value.trim().length < 2) errors.name = 'Nama minimal 2 karakter';
        break;
      case 'email': {
        const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        if (!value) errors.email = 'Email wajib diisi';
        else if (!emailRegex.test(value)) errors.email = 'Masukkan email yang valid';
        break;
      }
      case 'password':
        if (!value) errors.password = 'Kata sandi wajib diisi';
        else if (value.length < 6) errors.password = 'Kata sandi minimal 6 karakter';
        break;
    }
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-bold text-gray-800">Buat Akun Anda</h2>
                <p className="text-gray-600">Bergabunglah dengan ribuan penggemar properti</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.div variants={inputVariants}>
                ...
                <div className="relative group">
                  <div className={`absolute left-3 top-1/2 -translate-y-1/2 transition-colors duration-200 ${fieldFocus.name ? 'text-blue-500' : 'text-gray-400'
                    }`}>
              ...
              <motion.div variants={inputVariants}>
                ...
                <div className="relative group">
                  <div className={`absolute left-3 top-1/2 -translate-y-1/2 transition-colors duration-200 ${fieldFocus.email ? 'text-blue-500' : 'text-gray-400'
                    }`}>
              ...
              <motion.div variants={inputVariants}>
                ...
                <div className="relative group">
                  <div className={`absolute left-3 top-1/2 -translate-y-1/2 transition-colors duration-200 ${fieldFocus.password ? 'text-blue-500' : 'text-gray-400'
                    }`}>
                  ...
                  {formData.password && (
                    ...
                    >
                      <div className="flex items-center space-x-2 mb-1">
                        <span className="text-sm text-gray-600">Kekuatan kata sandi:</span>
              ...
              <motion.div variants={inputVariants}>
                ...
                >
                  <span className="group-hover:mr-2 transition-all duration-200">Masuk ke akun Anda</span>
