...
const quickFilters = [
  { label: "Apartemen", icon: Home, count: "2.5k+" },
  { label: "Rumah", icon: Home, count: "1.8k+" },
  { label: "Vila", icon: Home, count: "750+" },
  { label: "Studio", icon: Home, count: "1.2k+" }
];

const stats = [
  { icon: Users, value: "50K+", label: "Pelanggan Puas", color: "from-blue-500 to-cyan-500" },
  { icon: Home, value: "25K+", label: "Properti Terdaftar", color: "from-green-500 to-emerald-500" },
  { icon: Star, value: "4.9", label: "Rating Rata-rata", color: "from-yellow-500 to-orange-500" },
  { icon: Shield, value: "100%", label: "Properti Terverifikasi", color: "from-purple-500 to-pink-500" }
];
                ...
                <div className="bg-white/95 backdrop-blur-md rounded-3xl p-6 shadow-2xl border border-white/50">
                  ...
                  <div className="flex flex-col lg:flex-row gap-4">
                    <div className="relative flex-1">
                      <MapPin className={`absolute left-4 top-1/2 transform -translate-y-1/2 transition-colors duration-300 ${isSearchFocused ? 'text-blue-500' : 'text-gray-400'
                        }`} />
                      <input
                        type="text"
                        value={searchQuery}
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-xs text-gray-500">
                                      {Math.floor(Math.random() * 500) + 100}+ properti
                                    </div>
                                  </div>
                                </div>
