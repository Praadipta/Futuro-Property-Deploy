                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    >
                      ...
                      <div className="hidden lg:flex flex-col items-start">
                        ...
                        <span className="text-xs text-gray-500">Anggota Premium</span>
                      </div>
                      <motion.div
...
const NavLinks = ({ currentPath }) => {
  ...
  const navLinks = [
    ...
    },
    {
      ...
      description: "Temukan impian Anda"
    },
    {
      name: "Tentang Kami",
      path: "/about",
  ...
  return (
    <div className="flex space-x-2 items-center">
      ...
      {/* Enhanced AI Property Hub Link - DISABLED FOR NOW
      <motion.div
...
const MobileNavLinks = ({
  ...
  return (
    ...
    >
      {/* Enhanced AI Property Hub for Mobile - DISABLED FOR NOW
      <motion.div 
      ...
      */}
      ...
      <div className="flex items-center gap-4 px-2">
        ...
        <span className="text-xs text-gray-400 font-medium">Navigasi</span>
        <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
      </div>
      ...
      <div className="pt-4 mt-2">
        <div className="flex items-center gap-4 px-2 mb-4">
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
          <span className="text-xs text-gray-400 font-medium">Akun</span>
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
        </div>
          ...
          >
              ...
              <div className="flex items-center space-x-4 relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-xs text-yellow-600 font-semibold">Anggota Premium</span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-700">Tersimpan</span>
              </motion.button>
              <motion.button
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-3 px-4 py-3 bg-white border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-all"
