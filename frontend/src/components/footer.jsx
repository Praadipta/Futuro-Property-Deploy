...
const SocialLinks = () => {
  return (
    <div className="flex items-center gap-4 mt-8">
      <span className="text-sm text-gray-600 font-medium">Ikuti kami:</span>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-xl font-bold text-gray-800">Tetap Terupdate</h3>
      </div>

      <p className="text-gray-600 mb-6 text-sm leading-relaxed">
        Dapatkan daftar properti terbaru, wawasan pasar, dan penawaran eksklusif langsung ke email Anda.
      </p>
      ...
      <p className="mt-4 text-xs text-gray-500 flex items-center gap-1">
        ...
        Dengan berlangganan, Anda menyetujui <a href="#" className="underline hover:text-blue-600 transition-colors">Kebijakan Privasi</a> kami.
      </p>
    </motion.div>
  );
};
...
const companyLinks = [
  ...
  { name: 'Properti', href: '/properties', icon: MapPin },
  { name: 'Tentang Kami', href: '/about', icon: Star },
  { name: 'Kontak', href: '/contact', icon: Mail },
  { name: 'AI Property Hub', href: '/ai-agent', icon: Zap },
];

const helpLinks = [
  { name: 'Dukungan Pelanggan', href: '/', icon: Heart },
  { name: 'FAQ', href: '/', icon: Sparkles },
  { name: 'Syarat & Ketentuan', href: '/', icon: Shield },
  { name: 'Kebijakan Privasi', href: '/', icon: Clock },
];
...
const contactInfo = [
  ...
  {
    icon: Phone,
    text: '+62 851 2441 3524',
    href: 'tel:+6285124413524'
  },
  {
    icon: Mail,
    text: 'contact@futuroproperty.com',
    href: 'mailto:contact@futuroproperty.com'
  },
];
      ...
      <div className="relative pt-16 lg:pt-20 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center lg:justify-start mb-6">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500 font-medium">Properti Premium</p>
              </div>
            </div>
            ...
            >
              Mitra terpercaya Anda dalam menemukan rumah sempurna. Kami membuat pencarian properti menjadi sederhana, efisien, dan disesuaikan dengan kebutuhan unik Anda dengan teknologi canggih dan layanan personal.
            </motion.p>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <MobileFooterSection title="Tautan Cepat" icon={Home}>
            ...
            <MobileFooterSection title="Dukungan" icon={Heart}>
              <ul className="space-y-2">
                {helpLinks.map(link => (
                  <li key={link.name}>
                    <FooterLink href={link.href} icon={link.icon}>
            ...
            <MobileFooterSection title="Hubungi Kami" icon={MapPin}>
              <ul className="space-y-3">
                {contactInfo.map((item, index) => (
                  <li key={index}>
                    <motion.a
